  ...
  return (
    <div className="bg-neutral-100 min-h-screen px-6 py-12 text-neutral-900 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        {error && <div className="flex items-center gap-2 bg-red-100 text-red-700 p-3 rounded-lg text-sm font-semibold mb-6"><FaInfoCircle /><span>{error}</span></div>}
            ...
            <div className="md:col-span-1 bg-white p-8 rounded-3xl shadow-md space-y-8">
                ...
                <div>
                    ...
                    <div className="flex flex-col justify-between items-center bg-lime-50 rounded-xl p-4">
                        ...
                        <button className={`w-full px-6 py-3 rounded-xl font-bold transition-all duration-300 mt-4 ${!isStripeEnabled || availableAmount <= 0 || busy ? "bg-neutral-300 text-neutral-500 cursor-not-allowed" : "bg-lime-500 text-white hover:bg-lime-600 transform hover:scale-105"}`} onClick={handleWithdraw} disabled={!isStripeEnabled || availableAmount <= 0 || busy}>
